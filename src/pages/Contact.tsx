        ...
        <AnimatedSection>
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-lg md:text-xl text-gray-600">
              Have questions about our services? Want to discuss your requirements? 
              ...
              <div className="bg-white rounded-xl shadow-sm p-8 h-full">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 bg-infiw3b-100 p-3 rounded-full text-infiw3b-600">
                      <Phone className="h-6 w-6" />
                    </div>
                    <div className="ml-4">
                      <h3 className="text-lg font-medium text-gray-900">Phone</h3>
                      <p className="text-gray-600 mt-1">+91 749955187</p>
                      <p className="text-gray-600">+91 9433313760</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-gray-600 mt-1">infiw3b@yahoo.com</p>
                    </div>
                  </div>
                ...
                <div className="mt-8">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-infiw3b-100 p-2 rounded-full text-infiw3b-600 hover:bg-infiw3b-200 transition-colors">
